...
public class Controller extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String action = request.getServletPath();// variavel que armazena o caminho da requisicao
		// System.out.println(action);// verificando o caminho da requisicao
	...
	protected void contatos(HttpServletRequest request, HttpServletResponse response)
		...
		rd.forward(request, response);// encaminha o obj lista ao doc agenda.jsp
...
//		System.out.println(request.getParameter("email"));
	...
	protected void editarContato(HttpServletRequest request, HttpServletResponse response)
		...
		// redirecionar para documento agenda.jsp atualizando as alteracoes
		response.sendRedirect("main");
		// teste de recebimento
		/*
	 ...
	 */
	// remover um contato
	public void removerContato(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
//		System.out.println(idcon);
		// setar a variavel idcon JavaBeans
		contato.setIdcon(request.getParameter("idcon"));
		// executar o metodo deletarContato (DAO) passando o obj contato
	...
	public void gerarRelatorio(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// criar uma tabela
			PdfPTable tabela = new PdfPTable(3);// 3=> indica que vai ter 3 colunas
			// criar cabeçalho
